...
@override
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                financialItem('Set Goals', '6', Colors.blue, Icons.flag_outlined),
                                financialItem('View Transactions', '10', Colors.blue, Icons.euro)
                              ],),
                              
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  financialItem('Categories graph', '6', Colors.blue, Icons.graphic_eq),
                                  financialItem('Set Budget', '6', Colors.blue, Icons.shopping_basket_outlined)
                                ],
                              )
                            ],
                          ),
  ...
  Widget financialItem(String title,String value,Color color,IconData icon){
    return Container(
                                height: 70.h,
                                width: 150.w,
                                decoration: BoxDecoration(
